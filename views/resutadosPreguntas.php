...
<head>
    ...
    <title>QUIZZPRINT | Resultados</title>
</head>
...
<body>
    ...
    <section class="container my-3">
        ...
        <h1 class="dashboard-title mb-2">Resultados generales.</h1>
        <p class="text-secondary mb-4">
            Visualizar resultados de las respuestas de los estudiantes |
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // Mapeo de opciones del select con el texto exacto de la columna
            const mapFiltro = {
                "estudiante": "Estudiante",
                "universitario": "Estudiante Universitario",
                "profesional": "Profesional / Maestro"
            };
            ...
            document.getElementById("nivel_estudio").addEventListener("change", function() {
                ...
                if (valor === "") {
                    tabla.column(2).search("").draw(); // Mostrar todo
                } else {
                    tabla.column(2).search(mapFiltro[valor]).draw(); // Filtrar por nivel
                }
            });
        });
    </script>
